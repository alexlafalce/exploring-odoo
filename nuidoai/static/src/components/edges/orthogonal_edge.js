...
export class OrthoEdge extends Edge {
}
...
export class OrthoEdgeModel extends EdgeModel {
    static get pathClass() {
        return OrthoPath;
    }
}
registry.category(NuidoEdgeRegistryName).add(OrthoEdge.name, {
    component: OrthoEdge,
    model: OrthoEdgeModel
});
